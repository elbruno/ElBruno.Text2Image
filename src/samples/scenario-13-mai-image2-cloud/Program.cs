...
// using var generator = new MaiImage2Generator(endpoint, apiKey, modelName: modelName, modelId: modelId, httpClient: httpClient);

using var generator = new MaiImage2Generator(endpoint, apiKey, modelName: modelName, modelId: modelId);
