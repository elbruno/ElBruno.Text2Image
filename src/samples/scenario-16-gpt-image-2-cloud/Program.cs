...
Console.WriteLine("=== ElBruno.Text2Image - GPT-Image-2 Cloud API Demo (Azure OpenAI) ===");
Console.WriteLine();
...
var endpoint = config["GptImage2:Endpoint"];
var apiKey = config["GptImage2:ApiKey"];
var model = config["GptImage2:Model"] ?? "gpt-image-2";

if (string.IsNullOrEmpty(endpoint) || string.IsNullOrEmpty(apiKey))
{
    Console.WriteLine("ERROR: GptImage2:Endpoint and GptImage2:ApiKey are not configured.");
    Console.WriteLine();
    ...
    Console.WriteLine("    dotnet user-secrets set GptImage2:Endpoint \"https://your-resource.openai.azure.com\"");
    Console.WriteLine("    dotnet user-secrets set GptImage2:ApiKey \"your-api-key-here\"");
    Console.WriteLine("    dotnet user-secrets set GptImage2:Model \"gpt-image-2\"");
    Console.WriteLine();
    Console.WriteLine("  Option 2 - Environment Variables:");
    Console.WriteLine("    set GptImage2__Endpoint=https://your-resource.openai.azure.com");
    Console.WriteLine("    set GptImage2__ApiKey=your-api-key-here");
    Console.WriteLine("    set GptImage2__Model=gpt-image-2");
    Console.WriteLine();
    Console.WriteLine("  Option 3 - appsettings.json:");
    Console.WriteLine("    { \"GptImage2\": { \"Endpoint\": \"...\", \"ApiKey\": \"...\", \"Model\": \"gpt-image-2\" } }");
    Console.WriteLine();
...
Console.WriteLine("GPT-Image-2 cloud model ready");
Console.WriteLine();
