...
/// <summary>
/// GPT-Image-1.5 Azure OpenAI image generator.
...
public sealed class GptImage1p5Generator : IImageGenerator, Microsoft.Extensions.AI.IImageGenerator
{
    ...
    public GptImage1p5Generator(string endpoint, string apiKey, HttpClient httpClient, string? modelName = null, string? deploymentName = null, int? timeoutSeconds = null)
    {
